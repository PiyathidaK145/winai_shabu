...
<head>
    <meta charset="UTF-8">
    <title>รายการความคิดเห็นของลูกค้า</title>
    ...
    <div class="row">
        <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
            <div class="container mt-4">
                <h3 class="mb-4"><strong>รายการความคิดเห็นของลูกค้า</strong></h3>
                <form method="GET" action="comment_list.php" class="mb-3">
                    ...
                    <table id="tableUse" class="table_use table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td>{$row['rating_selac']}</td>
                                <td>
                                    <strong>ความสะอาด :</strong> {$row['clean_tag']}<br>
                                    <strong>อาหาร : </strong>{$row['food_tag']}<br>
                                    <strong>การบริการ : </strong>{$row['service_tag']}<br>
                                    <strong>ราคา : </strong>{$row['price_tag']}<br>
                                    <strong>อื่นๆ : </strong>{$row['other_tag']}
                                </td>

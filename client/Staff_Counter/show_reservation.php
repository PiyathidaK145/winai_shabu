...
<body>
    <div class="container-fluid">
        <div class="row">
            <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
                <h2 class="mb-4">รับโต๊ะ <?php echo htmlspecialchars($table_id); ?> (Reservation id: <?php echo htmlspecialchars($reservation_id); ?>)</h2>
                <form action="process_selection_reservation.php" method="POST">

                    <!-- Hidden Resevation Data -->
    ...
    WHERE 
        (pi.for_customer_type = 'resevation' OR pi.for_customer_type = 'both')

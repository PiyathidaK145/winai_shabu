        ...
        <main>
            ...
            <section id="image-gallery">
                <div class="image-grid">
                    <?php
                    $meats = [
                        ['src' => '../img/seafood/กุ้งอาเจน.png', 'name' => 'กุ้งอาเจน'],
                        ['src' => '../img/seafood/ขาปูพรีเมียม.png', 'name' => 'ขาปูพรีเมียม'],
                        ['src' => '../img/seafood/เนื้อปลาสด.jpg', 'name' => 'เนื้อปลาสด'],
                        ['src' => '../img/seafood/หอยแมลงภู่นิวซีแลนด์.jpg', 'name' => 'หอยแมลงภู่นิวซีแลนด์'],
                        ['src' => '../img/seafood/เนื้อกุ้งสด.jpg', 'name' => 'เนื้อกุ้งสด'],
                        ['src' => '../img/seafood/ปลาหมึกกรอบ.png', 'name' => 'ปลาหมึกกรอบ'],

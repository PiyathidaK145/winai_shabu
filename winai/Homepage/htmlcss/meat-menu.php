            ...
            <section id="image-gallery">
                <div class="image-grid">
                    ...
                    $meats = [
                        ...
                        ['src' => '../img/meat/เนื้อสไลด์ออส.png', 'name' => 'เนื้อพื้นท้องวัวออสเตรเลียสไลซ์แช่แข็ง'],
                        ['src' => '../img/meat/สามชั้นสไลด์เมกา.png', 'name' => 'ชุดเนื้อนำเข้า U.S สไลซ์'],
                        ['src' => '../img/meat/เนื้อวัว 3.jpg', 'name' => 'เนื้อวากิวญี่ปุ่น A4'],
                        ['src' => '../img/meat/วากิวญี่ปุ่น.png', 'name' => 'เนื้อวากิวญี่ปุ่น A5'],

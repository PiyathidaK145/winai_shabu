    ...
    if ($availability_id > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<script>
                    ...
                    window.location.href = '../Home/Homepage.php?table={$_GET['table']}&cancel=true';
                  </script>";
        } else {
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../CSS/stylesCancel.css">
</head>
<body>
<div class="success-box">
    ...
    <form method="POST">
        ...
        <?php if ($is_cancelled): ?>
            <button type="button" onclick="window.location.href='../Home/Homepage.php'">กลับหน้าแรก</button>
        <?php else: ?>

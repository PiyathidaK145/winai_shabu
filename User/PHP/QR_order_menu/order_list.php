...
if (!isset($_GET['reservation_id']) || empty($_GET['reservation_id'])) {
    echo "<script>alert('กรุณาระบุรหัสการจอง'); window.location.href='../Home/Homepage.php';</script>";
    exit();
}
...
<body>
    <div class="container">
        ...
        <!-- ปุ่มชำระเงิน -->
        <button onclick="window.location.href='../Payment/payment.php?reservation_id=<?php echo $reservation_id; ?>'">ชำระเงิน</button>

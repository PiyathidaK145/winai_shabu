document.addEventListener("DOMContentLoaded", function () {
    ...
    submitButton.addEventListener("click", function (event) {
        ...
        // ส่งข้อมูลไปยัง PHP
        fetch('http://localhost:8081/winai_shabu-main/User/PHP/Review/review.php', {
            method: 'POST',
            body: formData
        })
            ...
            .then(data => {
                ...
                window.location.href = '../Review/thankyou.php';
            })
